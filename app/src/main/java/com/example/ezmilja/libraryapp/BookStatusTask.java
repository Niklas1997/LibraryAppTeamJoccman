...
public class BookStatusTask extends AsyncTask<Object, Object, String> {

        private ProgressDialog pDialog;
        private Context context;
        private static final String TAG = BookStatusTask.class.getName();

        public BookStatusTask(Context context){
        ...
        protected String doInBackground(Object... params) {
            try{
                ...
                String u = "http://159.107.165.157:8000/Book/" + "/" + book.getId() + "/";
