...
/**
 * Created by emirmun on 26/07/2017.
 */

public class NewRquestTask extends AsyncTask<Object, Object, String> {

        private ProgressDialog pDialog;
        private Context context;
        private static final String TAG = NewRquestTask.class.getName();

        public NewRquestTask(Context context){
