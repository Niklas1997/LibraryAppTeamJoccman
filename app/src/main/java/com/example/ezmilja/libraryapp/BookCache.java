...
public class BookCache {
    ...
    private BookCache(){
        ...
        books.put(8, new Book(8, "ISBN: 978-0007350544", "Bounce", R.drawable.bounce, "Matthew Syed", "Matthew explains why some people thrive under pressure and others choke, He weighs the value of innate ability against that of practice, hard work and will. From sex to maths, from the motivation of children to the culture of big business, Bounce shows how competition provides a master key with which to unlock the mysteries of success. ","Page Count:272", "28/04/11 Fourth Estate",2));
